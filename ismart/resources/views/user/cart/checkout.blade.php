            ...
            <div class="section-detail">
                <div class="form-row clearfix">
                    <div class="form-col fl-left">
                        ...
                        <input type="text" name="fullname" id="fullname" value="{{ old('fullname') }}" placeholder="Nhập họ tên người nhận">
                        @error('fullname')
                    ...
                    <div class="form-col fl-right">
                        ...
                        <input type="text" name="phone" id="phone" value="{{ old('phone') }}" placeholder="Nhập số điện thoại người nhận">
                        @error('phone')
                        <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    <div class="form-col">
                        ...
                        <input type="text" name="email" value="{{ old('email') }}" id="email" placeholder="Nhập email">
                        @error('email')
                        <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    <div class="form-col">
                        ...
                        <input type="text" name="address" id="address" placeholder="Nhập số nhà, đường, phường ...." value="{{ old('address') }}">
                        @error('address')
                        <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
