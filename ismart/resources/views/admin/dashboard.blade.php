...
<div class="container-fluid py-3">
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="card text-white bg-primary mb-3">
                <div class="card-header">ĐƠN HÀNG BÁN CHẠY NHẤT <span class="bestSeller">Số lượng: {{$totalProductBestSeller}} </span></div>
                <div class="card-body">
                    <h5 class="card-title">{{ $productBestSeller }}</h5>
        ...
        <div class="col">
            <div class="card text-white bg-info mb-3">
                <div class="card-header">SỐ KHÁCH HÀNG MUA TRONG NGÀY</div>
                <div class="card-body">
                    <h5 class="card-title">{{ $countUserBuyProduct }}</h5>
                </div>
            </div>
        </div>
    </div>
                ...
                <tbody class="text-center">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('order.seen', ['id' => $item->id]) }}" class="btn btn-info btn-sm rounded-0" data-toggle="tooltip" title="Chi tiết"><i class="fas fa-eye"></i></a>
                            @endif
                        </td>
                    </tr>
                    @endforeach
